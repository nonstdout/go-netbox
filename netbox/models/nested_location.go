...
func (m *NestedLocation) validateName(formats strfmt.Registry) error {
...
func (m *NestedLocation) validateSlug(formats strfmt.Registry) error {
...
func (m *NestedLocation) validateURL(formats strfmt.Registry) error {
...
func (m *NestedLocation) contextValidateDepth(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedLocation) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedLocation) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedLocation) contextValidateRackCount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedLocation) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
