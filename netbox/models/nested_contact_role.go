...
func (m *NestedContactRole) validateName(formats strfmt.Registry) error {
...
func (m *NestedContactRole) validateSlug(formats strfmt.Registry) error {
...
func (m *NestedContactRole) validateURL(formats strfmt.Registry) error {
...
func (m *NestedContactRole) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedContactRole) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedContactRole) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
