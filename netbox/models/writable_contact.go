...
func (m *WritableContact) validateCreated(formats strfmt.Registry) error {
...
func (m *WritableContact) validateURL(formats strfmt.Registry) error {
...
func (m *WritableContact) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableContact) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableContact) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
