...
func (m *NestedSite) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedSite) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedSite) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
