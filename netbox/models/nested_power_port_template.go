...
func (m *NestedPowerPortTemplate) validateName(formats strfmt.Registry) error {
...
func (m *NestedPowerPortTemplate) validateURL(formats strfmt.Registry) error {
...
func (m *NestedPowerPortTemplate) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedPowerPortTemplate) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedPowerPortTemplate) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedPowerPortTemplate) UnmarshalBinary(b []byte) error {
	var res NestedPowerPortTemplate
