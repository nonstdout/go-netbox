...
func (m *WritableLocation) validateCreated(formats strfmt.Registry) error {
...
func (m *WritableLocation) validateLastUpdated(formats strfmt.Registry) error {
...
func (m *WritableLocation) validateURL(formats strfmt.Registry) error {
...
func (m *WritableLocation) contextValidateDepth(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableLocation) contextValidateDeviceCount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableLocation) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableLocation) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableLocation) contextValidateRackCount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableLocation) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
