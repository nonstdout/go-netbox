...
func (m *NestedManufacturer) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedManufacturer) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
