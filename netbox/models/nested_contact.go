...
func (m *NestedContact) validateName(formats strfmt.Registry) error {
...
func (m *NestedContact) validateURL(formats strfmt.Registry) error {
...
func (m *NestedContact) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedContact) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedContact) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
