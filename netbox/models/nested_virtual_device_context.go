...
func (m *NestedVirtualDeviceContext) validateDevice(formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) validateIdentifier(formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) validateName(formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) validateURL(formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedVirtualDeviceContext) UnmarshalBinary(b []byte) error {
	var res NestedVirtualDeviceContext
