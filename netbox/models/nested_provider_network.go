...
func (m *NestedProviderNetwork) validateName(formats strfmt.Registry) error {
...
func (m *NestedProviderNetwork) validateURL(formats strfmt.Registry) error {
...
func (m *NestedProviderNetwork) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedProviderNetwork) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedProviderNetwork) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
