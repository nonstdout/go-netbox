...
func (m *NestedCluster) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedCluster) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedCluster) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedCluster) contextValidateVirtualmachineCount(ctx context.Context, formats strfmt.Registry) error {
